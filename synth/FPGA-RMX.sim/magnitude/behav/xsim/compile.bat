...
REM
REM Generated by Vivado on Sun Nov 30 02:53:19 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj magnitude_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj magnitude_tb_vlog.prj -log xvlog.log
